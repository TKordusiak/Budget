...
<html>
<head>
    <title>Budżet domowy - rejestracja</title>
   ...
   <div class="container">
		<div class="col-sm-6 col-md-4 col-md-offset-4">
			<form class="form-signin" method="post" action="register">
				...
				<input name="inputName" type="text" name="inputName" class="form-control" placeholder="Nazwa użytkownika" required autofocus />
